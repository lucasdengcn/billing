...
class ProductServiceDeleteFeaturesByProductTest {
    ...
    @Test
    void deleteFeaturesByProduct_WhenProductDoesNotExist_ShouldCompleteSuccessfully() {
        // Given

        // When & Then
        productService.deleteFeaturesByProduct(999L);

        verify(productFeatureRepository).deleteByProduct_Id(any());
    }
